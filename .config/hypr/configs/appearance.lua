...
-- Default springs
hl.curve("easy",           { type = "spring", mass = 1, stiffness = 1000, dampening = 65 })
...
hl.animation({ leaf = "windows",       enabled = true,  speed = 0.25, spring = "easy" })
hl.animation({ leaf = "windowsIn",     enabled = true,  speed = 0.25, spring = "easy",         style = "popin 87%" })
hl.animation({ leaf = "windowsOut",    enabled = true,  speed = 0.15, bezier = "linear",       style = "popin 87%" })
...
hl.animation({ leaf = "fade",          enabled = true,  speed = 0.15, bezier = "quick" })
...
hl.animation({ leaf = "workspaces",    enabled = true,  speed = 0.15, bezier = "almostLinear", style = "fade" })
hl.animation({ leaf = "workspacesIn",  enabled = true,  speed = 0.1,  bezier = "almostLinear", style = "fade" })
hl.animation({ leaf = "workspacesOut", enabled = true,  speed = 0.15, bezier = "almostLinear", style = "fade" })
