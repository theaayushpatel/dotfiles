...
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd(p.terminal))
...
-- -- Applications
-- hl.bind(mainMod .. " + ALT + 1", hl.dsp.exec_cmd("brave"))
-- hl.bind(mainMod .. " + ALT + 2", hl.dsp.exec_cmd("obsidian"))
-- hl.bind(mainMod .. " + ALT + 3", hl.dsp.exec_cmd("code"))